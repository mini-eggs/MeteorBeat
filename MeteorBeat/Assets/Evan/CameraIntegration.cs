 ...
 *
 * On ship and asteroid collision this script will lock camera so user 
 * sees their explosion. Camera is locked until game is exited or level
 * restarts.
 */
public class CameraIntegration : MonoBehaviour
{

   // Signifies if user is in loss state, i.e. ship collided with 
   // asteroid.
